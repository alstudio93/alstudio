...
const AboutComp = () => {
    return (
        <section id="about" className='flex flex-col items-center max-w-4xl  mx-auto pt-60 gap-y-10 '>
            ...
            <span className='block text-2xl font-bold w-full'>Exciting News!</span>
            <p className='w-full'>
                ALStudio has officially partnered with <span><Link href="/"><a>LoomCo</a></Link></span>! <span className='block py-5 font-bold'>What does this mean for you?</span>Between ALStudio and LoomCo, we are now YOUR one-stop-shop for all of your brand identity needs!</p>
        </section>
    )
}
